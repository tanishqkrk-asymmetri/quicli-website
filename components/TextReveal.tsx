...
export default function Reveal() {
  ...
  return (
    <div className="text-5xl flex flex-col justify-center max-lg:px-12 items-center gap-16 max-xl:text-3xl max-lg:text-2xl max-md:text-3xl max-md:px-3 leading-16">
      {loaded && (
        <div className="w-full font-semibold space-y-16 max-lg:w-full">
